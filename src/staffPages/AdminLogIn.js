...
export default function AdminLogIn() {
    ...
    const logInUser= async (e)=>{
        ...
        try{
            await axios.post(`http://localhost:8888/admin/login`,{data}).then(
                (res)=>{
  ...
  return (
        <div className="grid justify-center content-center w-full  min-h-screen bg-gray-200">
            <h1 className='font-bold text-center text-[48px]'>Admin Login</h1>
            <form onSubmit={(e)=>logInUser(e)} class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-[500px] h-[300px]">
                ...
                <div className="mb-6">
                    ...
                    <input value={password} onChange={(e) => setPassword(e.target.value)} className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" name="password" type="password" required placeholder="******************" />
                </div>
